...
const Edit = ({
  ...
  const SortableSelect = (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_4__.SortableContainer)(react_select__WEBPACK_IMPORTED_MODULE_5__["default"]);
  ...
  const shows = useSelect(select => select('core').getEntityRecords('taxonomy', 'shows', {
    per_page: -1
  }), []);
  const videos = useSelect(select => {
    return selectedShow ? select('core').getEntityRecords('postType', 'video', {
      per_page: -1,
      shows: selectedShow
    }) : [];
  }, [selectedShow]);
  const onChangeSelectedShow = newSelectedShow => {
    ...
    setTimeout(() => {
      setAttributes({
        selectedVideos: []
      }); // Reset selectedVideos after selectedShow has been updated
    }, 500);
  };
  const onChangeSelectedVideos = selectedVideos => {
    setSelected(selectedVideos);
    setAttributes({
      selectedVideos: selectedVideos.map(selectedVideos => selectedVideos.value)
    });
  };
  ...
  const SortableMultiValue = (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_4__.SortableElement)(props => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_select__WEBPACK_IMPORTED_MODULE_6__.c.MultiValue, {
      ...props,
      innerProps: innerProps
    });
  });
  const SortableMultiValueLabel = (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_4__.SortableHandle)(props => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_select__WEBPACK_IMPORTED_MODULE_6__.c.MultiValueLabel, {
    ...props
  }));
  const onSortEnd = ({
    oldIndex,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select Video Show'),
    value: selectedShow,
    options: shows && [{
      label: 'Select any Show',
      value: ''
    }, ...shows.map(show => ({
      label: show.name,
      value: show.id
  ...
  }), selectedShow && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(SortableSelect
  ...
  , {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Number of Videos to Display'),
    value: postCount,
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"title":"Video Shows","$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/video-shows","version":"0.1.0","category":"widgets","icon":"playlist-video","description":"Example block created by Manthan Parmar.","example":{},"supports":{"html":false},"textdomain":"video-shows","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","attributes":{"postCount":{"type":"number","default":"3"},"selectedShow":{"type":"string","default":""},"selectedVideos":{"type":"array","default":[]},"selectedOption":{"type":"string","default":""}}}');
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_1__.name, {
  ...
  */
  ...
  save: () => null // No save necessary because the output is rendered server-side
});
})();
